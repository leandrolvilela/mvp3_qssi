...
def predict(form: PacienteSchema):
    ...
    Args:
        ...
        - anaemia                   (int)  : decrease of red blood cells or hemoglobin (boolean)
        - creatinine_phosphokinase  (int)  : level of the CPK enzyme in the blood (mcg/L)
        - diabetes                  (int)  : if the patient has diabetes (boolean)
        - ejection_fraction         (int)  : percentage of blood leaving the heart at each contraction  (percentage)
        - high_blood_pressure       (int)  : if the patient has hypertension (boolean)
        - platelets                 (int)  : platelets in the blood (kiloplatelets/mL)
        - sex                       (int)  : woman or man (binary)
        - serum_creatinine          (float): level of serum creatinine in the blood (mg/dL)
        - serum_sodium              (float): level of serum sodium in the blood (mEq/L)
        - smoking                   (int)  : if the patient smokes or not (boolean)
